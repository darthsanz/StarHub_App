...
const MovieDetails = () => {
  ...
  if (!isLoading && !movie) {
    return (
      <div className="text-center text-white mt-20 text-2xl flex flex-col items-center gap-4">
  ...
  const imageUrl = movie? `https://image.tmdb.org/t/p/original${movie.backdrop_path || movie.poster_path}`: "";
